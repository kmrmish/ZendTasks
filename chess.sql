...
--
-- Table structure for table `chessboard`
--
...
CREATE TABLE `chessboard` (
  ...
  `chess_piece` varchar(30) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `chessboard`
--

LOCK TABLES `chessboard` WRITE;
/*!40000 ALTER TABLE `chessboard` DISABLE KEYS */;
/*!40000 ALTER TABLE `chessboard` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `moves` (
  `id` smallint(6) NOT NULL AUTO_INCREMENT,
  `from_box_id` varchar(10) DEFAULT NULL,
  `to_box_id` varchar(10) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2014-09-01  7:26:41
